...
const CreateUser = ({ handleMenuClick, menu }) => {
  ...
  return (
    <>
      {menu.createUser && (
        <div className='rounded col-12 d-flex flex-column align-items-center p-1'>
          ...
          <form
            ...
            <div className='text-center'>
              <small className='text-success col-9 text-center'>
                ...
                <strong>
                  <i className='text-decoration-underline'>Ejemplo:</i> Nombre@1980
                </strong>
              </small>
            </div>
            {errors.password && (
            ...
            <div className='input-group align-items-center justify-content-center'>
              ...
              <div className='custom-control custom-checkbox mx-1'>
                ...
                <label
                  className='custom-control-label mx-1 text-danger'
