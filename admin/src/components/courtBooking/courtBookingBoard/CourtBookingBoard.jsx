                    ...
                    (reserve, i) =>
                      reserve.date === dateListLc[0] && (
                        <li
                          ...
                          className={
                            !reserve.permanent
                              ? 'text-center border border-light'
                              : 'text-center border border-danger'
                          }>
                          <span className='text-info small'>{reserve.user}</span>
                          ...
                          {reserve.info && (
                            <div className='p-0 text-center d-flex justify-content-center align-items-center border border-primary my-1'>
                              <i className='bi bi-info-circle-fill text-primary mx-1'></i>
                              <span className='text-dark small'>{reserve.info}</span>
                            </div>
                          )}
                        </li>
                      )
